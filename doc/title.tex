...
Zaplanowano i przeprowadzono szereg eksperymentów, na podstawie których udało się stwierdzić
poprawę wyników na 6 z 7 testowanych funkcji.
    \vspace*{1\baselineskip}
}
    ...
    \vspace*{1\baselineskip}
    {\itshape
This thesis anylyzes behaviour of known differential evolution variants -- DE/rand and DE/best.
In order to achieve better performance, new variant called DE/mid was proposed.
Series of experiments were planned and conducted,
DE/mid gave better results on 6 out of 7 testing functions.}
    \vspace*{1\baselineskip}
