...
public class JNIfgeneric
{
	 ...
	 * @param overwrite if true, any former directories are deleted and recreated, if false and a directory exists at
	 * outputPath, nothing is changed and false returned
	...
	/** Provides with a uniform random value generator. This function is provided for comparing the values of functions
	 * for different implementation of fgeneric. It fills the input argument r with double values comprised between 0
	 * and 1.
